...
def multi_player_game_loop(game_client):
    ...
    f1 = OnlineFighter(1, 200, 310, 40, 100, False, 10, 2,None)
    f2 = OnlineFighter(2, 700, 310, 40, 100, True, 10, 2,None)
    fighters = [f1, f2]
    ...
    while run:
        ...
        for message in game_client.get_updates():
            ...
            enemy_character.move_enemy(SCREEN_WIDTH, SCREEN_HEIGHT, screen, local_player, obstacles, game_client,
                                        message.keys)
