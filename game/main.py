...
def main_menu():
    while True:
        ...
        play = Button(image=pygame.image.load("game/assets/Play Rect.png"), pos=(500, 150),
        ...
        options = Button(image=pygame.image.load("game/assets/Options Rect.png"), pos=(500, 400),
                         text_input="OPTIONS", font=font(55), base_color="#d7fcd4", hovering_color="White")
        quit = Button(image=pygame.image.load("game/assets/Quit Rect.png"), pos=(500, 525),
