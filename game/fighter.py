...
class OnlineFighter(Fighter):
    ...
    def __init__(self, player, x, y, width, height, flip, punch_sound, projectile_sound, hit_sound, game_client):
        super(player, x, y, width, height, flip, punch_sound, projectile_sound, hit_sound)
