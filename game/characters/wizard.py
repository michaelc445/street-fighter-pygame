...
def createWizard(inherit_from, player, x, y, flip, punch_sound, projectile_sound, hit_sound,controls,ai):
    ...
    return Wizard(player, x, y, flip, punch_sound, projectile_sound, hit_sound,controls,ai)