...
class StreetFighter:
    ...
    def game_loop(self):
        ...
        if not self.game_in_progress:
            ...
            if self.p1 == "wizard":
                self.fighter_1 = createWizard(Fighter, 1, 200, 310, False, self.punch_fx, self.projectile_fx,
                                              self.hit_fx, self.player1_controls)

            elif self.p1 == "nomad":
                self.fighter_1 = createNomad(Fighter, 1, 200, 310, False, self.punch_fx, self.projectile_fx,
                                             self.hit_fx, self.player1_controls)

            elif self.p1 == "warrior":
                self.fighter_1 = createWarrior(Fighter, 1, 200, 310, False, self.punch_fx, self.projectile_fx,
                                               self.hit_fx, self.player1_controls)

            if self.p2 == "wizard":
                self.fighter_2 = createWizard(Fighter, 2, 700, 310, True, self.punch_fx, self.projectile_fx,
                                              self.hit_fx, self.player2_controls)

            elif self.p2 == "nomad":
                self.fighter_2 = createNomad(Fighter, 2, 700, 310, True, self.punch_fx, self.projectile_fx, self.hit_fx,
                                             self.player2_controls)

            elif self.p2 == "warrior":
                self.fighter_2 = createWarrior(Fighter, 2, 700, 310, True, self.punch_fx, self.projectile_fx,
                                               self.hit_fx, self.player2_controls)
    ...
    def menu_play(self):
        ...
        single_player = Button(image=pygame.image.load(self.resource_path("game/assets/menu/long.png")), pos=(500, 150),
                               text_input="SINGLEPLAYER", font=self.font(35), base_color="#d7fcd4",
    ...
    def menu_char(self):
        ...
        p1_warrior = Button(image=None, pos=(300, 400),
                            text_input="warrior", font=self.font(25), base_color=p1_color_warrior,
        ...
        p2_warrior = Button(image=None, pos=(700, 400),
                            text_input="warrior", font=self.font(25), base_color=p2_color_warrior,
                            hovering_color="Blue")
        p2_nomad = Button(image=None, pos=(700, 150),
