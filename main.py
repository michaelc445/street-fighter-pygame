...
class Main:
    def __init__(self):
        ...
        # load bg image
        self.bg_image = pygame.image.load(self.resource_path("game/assets/maps/background.png")).convert_alpha()
    ...
    # font size
    def font(self,size):
        return pygame.font.Font(self.resource_path("game/assets/menu/font.ttf"), size)
    ...
    def controls(self):
        ...
        while True:
            ...
            controls_player1 = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 175),
                                      text_input="Player 1", font=self.font(35), base_color="#d7fcd4", hovering_color="White")

            controls_player2 = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 325),
                                      text_input="Player 2", font=self.font(35), base_color="#d7fcd4", hovering_color="White")

            controls_back = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 475),
    ...
    def player1(self):
        ...
        while True:
            ...
            player1_back = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 475),
                                  text_input="BACK", font=self.font(35), base_color="#d7fcd4", hovering_color="White")
    ...
    def player2(self):
        ...
        while True:
            ...
            player2_back = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 475),
                                  text_input="BACK", font=self.font(35), base_color="#d7fcd4", hovering_color="White")
    ...
    def opt(self):
        ...
        while True:
            ...
            opt_controls = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 175),
                                  text_input="CONTROLS", font=self.font(35), base_color="#d7fcd4", hovering_color="White")
            opt_audio = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 325),
                               text_input="AUDIO", font=self.font(35), base_color="#d7fcd4", hovering_color="White")
            opt_back = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 475),
                              text_input="BACK", font=self.font(35), base_color="#d7fcd4", hovering_color="White")
    ...
    def audio(self):
        ...
        while True:
            ...
            audio_back = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 475),
                                text_input="BACK", font=self.font(35), base_color="#d7fcd4", hovering_color="White")
    ...
    def menu_play(self):
        menu_scaled = pygame.transform.scale(self.menu_bg, (self.SCREEN_WIDTH, self.SCREEN_HEIGHT))
        single_player = Button(image=pygame.image.load(self.resource_path("game/assets/menu/long.png")), pos=(500, 150),
                               text_input="SINGLEPLAYER", font=self.font(35), base_color="#d7fcd4", hovering_color="White")

        local = Button(image=pygame.image.load(self.resource_path("game/assets/menu/long.png")), pos=(500, 275),
                       text_input="LOCAL", font=self.font(35), base_color="#d7fcd4", hovering_color="White")

        multiplayer = Button(image=pygame.image.load(self.resource_path("game/assets/menu/long.png")), pos=(500, 400),
    ...
    def main_menu(self):
        menu_scaled = pygame.transform.scale(self.menu_bg, (self.SCREEN_WIDTH, self.SCREEN_HEIGHT))
        play = Button(image=pygame.image.load(self.resource_path("game/assets/menu/long.png")), pos=(500, 180),
                      text_input="PLAY", font=self.font(55), base_color="#d7fcd4", hovering_color="White")

        options = Button(image=pygame.image.load(self.resource_path("game/assets/menu/long.png")), pos=(500, 325),
                         text_input="OPTIONS", font=self.font(55), base_color="#d7fcd4", hovering_color="White")
        quit = Button(image=pygame.image.load(self.resource_path("game/assets/menu/medium.png")), pos=(500, 470),
