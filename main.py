...
class StreetFighter:
    ...
    def game_loop(self):
        ...
        if self.map == "mountain":
            self.p1_spawn = [100, 100]
            self.p2_spawn = [850, 100]
            self.map_chosen = "game/assets/maps/mountain.png"
            print(self.map_chosen)
            # mountain obstacles
            ...
            self.p1_spawn = [80, 100]
            self.p2_spawn = [900, 100]
            self.map_chosen = "game/assets/maps/church.png"
            print(self.map_chosen)
            # church obstacles
            ...
            self.p1_spawn = [500, 100]
            self.p2_spawn = [500, 400]
            self.map_chosen = "game/assets/maps/cliffs.png"
            print(self.map_chosen)
            # cliffs obstacles
        ...
        #load map
        print(self.map_chosen)
        self.bg_image = pygame.image.load(self.resource_path(self.map_chosen)).convert_alpha()
    ...
    def controls(self):
        ...
        while True:
            ...
            menu_scaled = pygame.transform.scale(menu_bg, (self.SCREEN_WIDTH, self.SCREEN_HEIGHT))
    ...
    def map_select():
        ...
        while True:
            ...
            pygame.display.update()
'''
    def ai_test_random_map_character(self):
        map_sel = random.randint(0,2)
        character_sel_p1 = random.randint(0,2)
        character_sel_p2 = random.randint(0, 2)
        maps = {0: "mountain", 1: "cliffs", 2: "church"}
        self.map = maps[map_sel]
        print(maps[map_sel])
        if character_sel_p1 == 0:
            self.p1 = "wizard"
            print("P1: "+"WIZARD")
        if character_sel_p1 == 1:
            self.p1 = "warrior"
            print("P1: " + "warrior")
        if character_sel_p1 == 2:
            self.p1 = "nomad"
            print("P1: " + "nomad")
        if character_sel_p2 == 0:
            self.p2 = "wizard"
            print("P2: " + "WIZARD")
        if character_sel_p2 == 1:
            self.p2 = "warrior"
            print("P2: " + "Warrior")
        if character_sel_p2 == 2:
            self.p2 = "nomad"
            print("P2: " + "nomad")
